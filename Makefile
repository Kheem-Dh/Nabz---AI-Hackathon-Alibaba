# Sehat Saathi — dev convenience targets.
# Requires: server/venv created and deps installed, client deps installed.

.PHONY: help install server client test eval mock-server

help:
	@echo "Sehat Saathi make targets:"
	...
	@echo "  make eval         Run the safety eval against :8000"
